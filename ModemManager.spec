...
%prep
%setup -q -n ModemManager-1.10.8
pushd ..
cp -a ModemManager-1.10.8 build32
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1572884725
...
cp %{_builddir}/ModemManager-1.10.8/COPYING %{buildroot}/usr/share/package-licenses/ModemManager/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/ModemManager-1.10.8/COPYING.LIB %{buildroot}/usr/share/package-licenses/ModemManager/01a6b4bf79aca9b556822601186afab86e8c4fbf
pushd ../build32/
%make_install32
