...
Source0  : https://www.freedesktop.org/software/ModemManager/ModemManager-1.18.12.tar.xz
...
%prep
%setup -q -n ModemManager-1.18.12
cd %{_builddir}/ModemManager-1.18.12
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1663693345
...
cp %{_builddir}/ModemManager-%{version}/COPYING %{buildroot}/usr/share/package-licenses/ModemManager/4cc77b90af91e615a64ae04893fdffa7939db84c || :
cp %{_builddir}/ModemManager-%{version}/COPYING.LIB %{buildroot}/usr/share/package-licenses/ModemManager/01a6b4bf79aca9b556822601186afab86e8c4fbf || :
%make_install
