...
Source0  : https://www.freedesktop.org/software/ModemManager/ModemManager-1.10.6.tar.xz
...
%prep
%setup -q -n ModemManager-1.10.6
pushd ..
cp -a ModemManager-1.10.6 build32
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1570748884
