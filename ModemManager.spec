...
Version  : 1.14.2
Release  : 26
URL      : https://www.freedesktop.org/software/ModemManager/ModemManager-1.14.2.tar.xz
Source0  : https://www.freedesktop.org/software/ModemManager/ModemManager-1.14.2.tar.xz
...
%prep
%setup -q -n ModemManager-1.14.2
cd %{_builddir}/ModemManager-1.14.2
pushd ..
cp -a ModemManager-1.14.2 build32
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1601051876
...
cp %{_builddir}/ModemManager-1.14.2/COPYING %{buildroot}/usr/share/package-licenses/ModemManager/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/ModemManager-1.14.2/COPYING.LIB %{buildroot}/usr/share/package-licenses/ModemManager/01a6b4bf79aca9b556822601186afab86e8c4fbf
pushd ../build32/
%make_install32
...
/usr/lib32/ModemManager/libmm-plugin-foxconn.so
...
/usr/lib32/ModemManager/libmm-plugin-tplink.so
